...
{
    /// <inheritdoc />
    public partial class updateSummarizeEpisodesFunc : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
               @"CREATE PROCEDURE dbo.proSummariseEpisodes 
                    AS BEGIN
        ...
        {
            migrationBuilder.Sql(@"DROP PROCEDURE dbo.proSummariseEpisodes");
        }
    }
}
