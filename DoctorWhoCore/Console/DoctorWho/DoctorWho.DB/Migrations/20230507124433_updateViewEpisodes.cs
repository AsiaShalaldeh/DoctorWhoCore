...
{
    /// <inheritdoc />
    public partial class updateViewEpisodes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                        @"CREATE VIEW dbo.updatedViewEpisodes AS
                        SELECT e.AuthorId, e.DoctorId, e.EpisodeId, a.AuthorName, d.DoctorName, 
        ...
        {
            migrationBuilder.Sql(@"DROP VIEW dbo.updatedViewEpisodes");
        }
    }
}
